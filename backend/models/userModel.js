...
const userSchema = new Schema(
    {
        ...
        // to get the default image we have gone to the image to database 64 here we have added our image in this platform and it has given us this code on copying image(copy image and not the code) After that we have pasted over there. 
        address: {
            type: Object,
            default: {line1: '', line2: ''}
        },
